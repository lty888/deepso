...
const SUB_PATH = process.env.SUB_PATH || 'ssl';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 7860;        // http服务订阅端口
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cleanip.662878.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOTgzNWI0ZGVhMTBmNzcwNzRhODkyYTczMDU5ZjM1NTMiLCJ0IjoiOTk3ZTE4YTEtOGM2YS00ZDFkLTgzYjYtZDkxNzg5M2FjMDQyIiwicyI6Ik0yTm1PV05oT1dZdFlUazNNQzAwWlRZekxUa3laVEV0T1RRMll6QTNZelJqWVdVNCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'cdns.doon.eu.org';        // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'face_sb';                        // 节点名称
